...
public class PublicController {
    ...
    @GetMapping("/package-items/{categoryId}")
    public ApiResponse<List<PackageItemDTO>> getItemsByCategory(@PathVariable Long categoryId) {
        return adminService.getItemsByCategory(categoryId);
    }
}
