 ...
 * </ul>
 * Legacy DB values may still contain {@code HUB_TO_HUB}; it is no longer offered for new orders.
 */
public final class FulfillmentType {
    ...
    /** @deprecated No longer selectable; retained for legacy order rows only */
    @Deprecated
